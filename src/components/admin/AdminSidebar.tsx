...
import { LayoutDashboard, Package, ShoppingCart, Tag, ArrowLeft, Scissors, CreditCard, FileText, Users, Truck } from "lucide-react";
...
const links = [
  ...
  { to: "/admin/shipping", icon: Truck, label: "Shipping Charges" },
